...
const DEFAULT_TOOLS: Tool[] = [
  {
    ...
    badge: "Web & Ads",
    badgeColor: "bg-cyan-500/20 text-cyan-500 font-black",
    accentColor: "cyan",
  ...
  },
  {
    ...
    badge: "Social Media",
    badgeColor: "bg-emerald-500/20 text-emerald-500 font-black",
    accentColor: "emerald",
  ...
  },
  {
    ...
    badge: "Tráfego Pago",
    badgeColor: "bg-orange-500/20 text-orange-500 font-black",
    accentColor: "orange",
  ...
  },
  {
    ...
    badge: "Webdesign",
    badgeColor: "bg-violet-500/20 text-violet-500 font-black",
    accentColor: "violet",
